...
import { TECH_BUSINESS_TYPE_GROUPS } from "@/lib/technology-business-types";
...
export function TechnologyBusinessTypePicker({ selectedIds, onChange }: Props) {
  ...
  return (
    <div className="grid gap-3 rounded-xl border border-cyan-500/15 bg-black/40 p-3 ring-1 ring-cyan-500/10">
      <div>
        <Label className="text-sm">Technology business types</Label>
      ...
      <div className="max-h-56 space-y-4 overflow-y-auto pr-1">
        {TECH_BUSINESS_TYPE_GROUPS.map((group) => (
